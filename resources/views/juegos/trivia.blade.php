...
const allQuestions = [
            ...
            { d: 'Fácil', q: "¿Qué cerro es famoso por sus casas de colores y el Paseo Atkinson?", o: ["Cerro Alegre", "Cerro Barón", "Cerro Esperanza", "Cerro Cárcel"], c: 0 },
            ...
            { d: 'Medio', q: "¿Qué nombre recibe el tradicional Mercado donde se encuentra la mejor gastronomía marina?", o: ["Mercado Cardonal", "Mercado Puerto", "Mercado Central", "Feria de la Avenida"], c: 1 },
            ...
            { d: 'Medio', q: "¿Cómo se llama el edificio que parece un barco en el Cerro Artillería?", o: ["Escuela Naval", "Museo Marítimo", "Aduana", "Fuerte Vergara"], c: 1 },
            ...
            { d: 'Difícil', q: "¿Cuál es el ascensor que tiene el trayecto más corto de la ciudad?", o: ["Ascensor El Peral", "Ascensor San Agustín", "Ascensor Reina Victoria", "Ascensor Espíritu Santo"], c: 2 },
            { d: 'Difícil', q: "¿Cómo se llamaba el antiguo barrio chino de Valparaíso, famoso por su bohemia extrema?", o: ["El Almendral", "Siete Espejos", "La Matriz", "Calle Larga"], c: 1 },
            { d: 'Leyenda', q: "¿Cuál fue el nombre de la primera locomotora que corrió entre Valparaíso y Viña en 1855?", o: ["La Porteña", "La Copiapó", "La Sebastiana", "La Joya"], c: 0 },
            ...
            { d: 'Fácil', q: "¿Cómo se llama el plan de Valparaíso que concentra el comercio?", o: ["El Centro", "El Puerto", "El Almendral", "La Explanada"], c: 2 },
            ...
            { d: 'Fácil', q: "¿Qué cerro tiene un reloj grande de flores en su entrada desde Viña?", o: ["Castillo", "Barón", "Esperanza", "Recreo"], c: 0 },
            { d: 'Fácil', q: "¿En qué país se encuentra Valparaíso?", o: ["Argentina", "Chile", "Perú", "Uruguay"], c: 1 },
            { d: 'Fácil', q: "¿Cómo se llaman las escaleras decoradas con arte?", o: ["Murales", "Graffitis", "Escaleras pintadas", "Pasajes"], c: 2 },
            { d: 'Fácil', q: "¿Qué océano baña las costas de Valparaíso?", o: ["Atlántico", "Índico", "Pacífico", "Antártico"], c: 2 },
            { d: 'Fácil', q: "¿Cuál es la principal actividad económica histórica de la ciudad?", o: ["Minería", "Agricultura", "Puerto", "Turismo"], c: 2 },
            { d: 'Fácil', q: "¿Qué cerro es famoso por su vida nocturna y hostales?", o: ["Alegre", "Placeres", "San Roque", "O'Higgins"], c: 0 },
            { d: 'Fácil', q: "¿Cómo se llama el festival musical más importante de la ciudad vecina?", o: ["Lollapalooza", "Viña del Mar", "Rockodromo", "Mil Tambores"], c: 1 },
            { d: 'Fácil', q: "¿Cuántos cerros se dice tradicionalmente que tiene Valparaíso?", o: ["20", "33", "45", "52"], c: 2 },
            { d: 'Fácil', q: "¿Cuál es la capital legislativa de Chile (donde está el Congreso)?", o: ["Santiago", "Concepción", "Valparaíso", "La Serena"], c: 2 },
            { d: 'Fácil', q: "¿Qué nombre recibe el trayecto de tren que une el puerto con Limache?", o: ["Merval", "Tren Central", "Ramal", "Expreso"], c: 0 },
            { d: 'Fácil', q: "¿Cómo se llama la plaza central de la ciudad donde está la Intendencia?", o: ["Plaza de Armas", "Plaza Victoria", "Plaza Bismarck", "Plaza Italia"], c: 1 },
            ...
            { d: 'Fácil', q: "¿Cuál es el principal medio de transporte público por las calles?", o: ["Taxis", "Metro", "Micros", "Bicicletas"], c: 2 },
            ...
            // MEDIO (30)
            { d: 'Medio', q: "¿Cuál es el nombre del primer diario de habla castellana fundado en el puerto?", o: ["La Nación", "El Mercurio", "La Estrella", "La Unión"], c: 1 },
            ...
            { d: 'Medio', q: "¿Qué cerro tiene un faro icónico cerca de Playa Ancha?", o: ["Punta Ángeles", "Artillería", "Mesilla", "Santo Domingo"], c: 0 },
            { d: 'Medio', q: "¿Cuál es el nombre del pasaje con escaleras que parecen teclas de piano?", o: ["Bavestrello", "Gálvez", "Pierre Loty", "Fisher"], c: 1 },
            ...
            { d: 'Medio', q: "¿Quién fue el arquitecto del Palacio Baburizza?", o: ["Smith Solar", "Barison y Schiavon", "Lucien Henault", "Joaquín Toesca"], c: 1 },
            { d: 'Medio', q: "¿Cómo se llama la caleta más famosa cerca del centro?", o: ["Portales", "El Membrillo", "Horcón", "Quintay"], c: 0 },
            { d: 'Medio', q: "¿Qué cerro es apodado 'El cerro de los niños'?", o: ["Alegre", "Larraín", "Mariposas", "Concepción"], c: 3 },
            ...
            { d: 'Medio', q: "¿Cuál es el nombre de la biblioteca pública mas importante del plan?", o: ["Severín", "Nacional", "Porteña", "Mistral"], c: 0 },
            ...
            { d: 'Medio', q: "¿Cuál es el ascensor que lleva al cerro Florida?", o: ["Florida", "Espíritu Santo", "Mariposas", "Monjas"], c: 1 },
            ...
            // DIFÍCIL (25)
            { d: 'Difícil', q: "¿Quién fue el fundador oficial (aunque no real) de Valparaíso en 1536?", o: ["Diego de Almagro", "Juan de Saavedra", "Pedro de Valdivia", "Francisco Pizarro"], c: 1 },
            ...
            { d: 'Difícil', q: "¿Cómo se llamaba la zona donde hoy está la Plaza Sotomayor antes del relleno?", o: ["La Matriz", "La Playa", "La Joya", "La Rinconada"], c: 3 },
            { d: 'Difícil', q: "¿Cuál fue el primer nombre del Cerro Alegre en la colonia?", o: ["Cerro de las Flores", "Cerro del Oro", "Cerro San Francisco", "Cerro Pelado"], c: 1 },
            { d: 'Difícil', q: "¿En qué año se inauguró el primer ascensor (Concepción)?", o: ["1883", "1890", "1901", "1875"], c: 0 },
            { d: 'Difícil', q: "¿Qué almirante británico lideró la Escuadra Nacional desde Valparaíso?", o: ["Nelson", "Lord Cochrane", "Drake", "Cook"], c: 1 },
            { d: 'Difícil', q: "¿Cuál es el nombre original del actual Cerro Barón?", o: ["Morro", "Cerro de la Cruz", "Cerro San Francisco", "Cerro de la Pólvora"], c: 2 },
            { d: 'Difícil', q: "¿Qué empresa de transportes operó los ascensores originalmente?", o: ["Empresa de Funiculares", "Cia. de Transportes Eléctricos", "Sociedad de Ascensores", "Chile-Argentina Rail"], c: 1 },
            { d: 'Difícil', q: "¿Cómo se llamaba el antiguo barrio bohemio 'Siete Espejos' hoy?", o: ["Plaza Echaurren", "Barrio Puerto", "Calle Blanco", "Cerro Cordillera"], c: 1 },
            { d: 'Difícil', q: "¿Quién diseñó el Edificio de El Mercurio de Valparaíso?", o: ["Smith Solar", "Cruz Montt", "Barison", "Hebard"], c: 0 },
            ...
            { d: 'Difícil', q: "¿Cuál fue el primer nombre del Cerro Playa Ancha?", o: ["Farallones", "Lomas Coloradas", "Campo de Marte", "Mesilla"], c: 3 },
            { d: 'Difícil', q: "¿Quién donó los fondos para construir la Universidad Santa María?", o: ["Federico Santa María", "Agustín Edwards", "Pascual Baburizza", "Pedro Montt"], c: 0 },
            { d: 'Difícil', q: "¿Qué cerro fue el primer centro residencial de la colonia?", o: ["Concepción", "Santo Domingo", "Cordillera", "Alegre"], c: 1 },
            ...
            { d: 'Difícil', q: "¿Qué institución bancaria tuvo su sede en el edificio del Reloj Turri?", o: ["Banco de Chile", "Caja Nacional", "Banco Italiano", "Banco de Londres"], c: 2 },
            ...
            { d: 'Difícil', q: "¿Qué cerro tiene el ascensor 'Villaseca'?", o: ["Artillería", "Playa Ancha", "Barón", "Santo Domingo"], c: 1 },
            { d: 'Difícil', q: "¿Cuál era la función original del actual Parque Cultural (Cárcel)?", o: ["Cuartel militar", "Cárcel pública", "Mercado", "Depósito de pólvora"], c: 3 },
            ...
            { d: 'Difícil', q: "¿Qué explorador italiano da nombre a una avenida en Playa Ancha?", o: ["Vespucio", "Colón", "Garibaldi", "Leopardi"], c: 2 },
            { d: 'Difícil', q: "¿Cuál es la calle mas angosta y curva del plan?", o: ["Cochrane", "Clave", "Serrano", "Blanco"], c: 1 },
            { d: 'Difícil', q: "¿Qué cerro tiene el Mirador Camogli?", o: ["Placeres", "Esperanza", "Recreo", "Barón"], c: 1 },

            // LEYENDA (10)
            { d: 'Leyenda', q: "¿Cuál es el significado original de la palabra 'Quintil' (nombre indígena)?", o: ["Lugar de pájaros", "Canto del mar", "Valle de luz", "Lugar de ballenas"], c: 0 },
            ...
            { d: 'Leyenda', q: "¿Cuál es el nombre del túnel ferroviario que atraviesa un cerro en el plan?", o: ["Túnel Castillo", "Túnel Barón", "Túnel Polanco", "Túnel Matta"], c: 0 },
            { d: 'Leyenda', q: "¿Cómo se llama el primer club de remo fundado en el puerto (1882)?", o: ["Canottieri", "Valparaíso Rowing", "Marítimo", "Naval"], c: 1 },
