...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:pl-3 items-center lg:justify-center min-h-screen flex-col">
      ...
      <div class="fixed top-0 right-0 w-40 py-2 px-4 z-50">
        <a href="{{ route('contacto.formulario') }}" class="block w-full text-center bg-black hover:bg-blue-700 text-white font-bold py-2 rounded">
            Contáctanos
        </a>
    </div>
        ...
        <div class="bg-gray-100 min-h-screen py-8">
            <div class="container mx-auto px-4 md:px-8 lg:px-12">
              <div class="lg:flex lg:items-start lg:justify-between">
                ...
                <img src="/storage/pionero_grande.png"
                ...
                <div class="lg:w-2/3 lg:ml-8">
                  <h1 class="md:text-center text-center text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-4">El Pionero de Valparaíso</h1>
                  <h2 class="text-xl md:text-2xl text-gray-600 mb-6">¡Menos postales, más realidad!</h2>
          
                  <div class="mb-8 text-gray-700">
                    <p class="mb-4">El Pionero de Valparaíso nace como un esfuerzo ciudadano por abordar los desafíos que enfrenta nuestra querida ciudad puerto. Cansados de la retórica vacía y las soluciones superficiales, buscamos ser un catalizador para el debate profundo y la propuesta de ideas concretas que realmente impacten en la calidad de vida de sus habitantes.</p>
                    <p class="mb-4">Creemos firmemente en el potencial de Valparaíso, en su riqueza cultural, su historia y su gente. 
                        Sin embargo, reconocemos los problemas que nos aquejan: el descuido de los espacios públicos, el transporte público, el deterioro del patrimonio, el empleo precario
                        ...
                        <p>Con la convicción de que <strong>un cambio de rumbo es esencial para construir un camino de progreso que traiga calidad de vida</strong>, aspiramos a ser un espacio donde las ideas se traduzcan en acciones concretas. Invitamos a expertos y académicos, 
                            a líderes comunitarios y a la voz de cada habitante de Valparaíso a unirse a este diálogo constructivo para edificar 
