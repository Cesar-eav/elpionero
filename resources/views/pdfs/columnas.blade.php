...
<body class="bg-gray-100 text-gray-900 font-serif text-base">
    <div class="w-full  mx-auto p-4">
        ...
        <div>
            ...
            <x-navbar />
            <!-- Newsletter -->
            <!-- Newsletter en una fila -->
            <section
                class="bg-white border border-gray-300 shadow-md rounded-lg my-8 p-4 md:p-6 flex flex-col md:flex-row items-center justify-between gap-4 max-w-7xl mx-auto">
